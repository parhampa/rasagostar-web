...
<div class="w3-main" style="margin-right:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5><b><i class="fa fa-dashboard"></i>جدول دستمزد</b></h5>
    </header>
    <div class="w3-white w3-padding-large w3-margin w3-round-medium w3-right" style="width: 80%;">
        ...
        $fm->alow_edit = false;
        $fm->alow_del = false;
        $fm->after_add_url = "dastmozd.php";
        $fm->set_tbl_key("dastmozd", "id", 1);
        $fm->fileinput("فایل دستمزدها", "file_plc", "w3-input", "w3-text-green", 1);
        $fm->input()
            ->inptype("submit")
            ->inpval("ثبت")
