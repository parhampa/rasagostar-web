...
<div class="w3-main" style="margin-right:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5><b><i class="fa fa-dashboard"></i>دسته بندی مطالب</b></h5>
    </header>
    <div class="w3-white w3-padding-large w3-margin w3-round-medium w3-right" style="width: 80%;">
        <?php
        $fm = new makeform();
        $fm->set_tbl_key("post_cat", "id", 1);
        $fm->label("عنوان دسته بندی", "w3-text-green")
            ->input()
            ->inpname("title")
            ->inpid("title")
            ->inptype("text")
            ...
            ->end()
            ->sndform("title", 0, 1, "عنوان دسته بندی", 1);
        $fm->input()
            ->inptype("submit")
            ->inpval("ثبت")
